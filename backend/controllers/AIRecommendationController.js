...
class AIRecommendationController {
    ...
    async getclientWorkoutNotes(req, res, next) {
        try {
            const result = await AIRecommendationService.getclientWorkoutNotes(req.params.id)
    ...
    async requestBusinessRecommendation(req, res, next) {
        try {
            const result = await AIRecommendationService.requestBusinessRecommendation(req.auditMeta, req.body, req.user)
