...
export function emailRequestmembership(client, request) {
  ...
  ">
    ...
    ">
      ...
      <p style="color:#333;font-size:14px;">
        Hello <b>${ucfirst(client.first_name)}</b>,
      </p>
      ...
      ">
        ...
        <p style="margin:0 0 8px 0;font-size:14px;">
          <b>Category:</b> ${ucfirst(request.client_type)}
        </p>
